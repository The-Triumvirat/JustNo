...
<div class="page-content">
  ...
  <div class="card">
    <div class="card-body p-4">
      <h5 class="mb-4">Edit Just No Reasons</h5>
      <form id="myForm" action="{{ route('backoffice.no-reasons.update', $noReason->id) }}" method="post" class="row g-3" enctype="multipart/form-data">
        @csrf
        ...
        <div class="form-group col-md-6">
          ...
          <input type="text" name="reason" class="form-control" id="reason" value="{{ $noReason->reason }}">
        </div>
